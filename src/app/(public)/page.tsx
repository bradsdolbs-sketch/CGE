...
const TESTIMONIALS: { text: string; name: string; detail: string }[] = [
  {
    text: "We have been with these guys as tenants since they started their business. They have been absolutely great in connecting us with everything we need — responsive, professional, and genuinely care.",
    name: 'Cameron Rouse',
    detail: 'Tenant',
  },
  {
    text: "We have worked with Central Gate for years and are happy to recommend as tenants. Claire is very responsive and helpful, keen to sort issues as quickly as possible.",
    name: 'Bhuwan Vashisht',
    detail: 'Long-term tenant',
  },
  {
    text: "Claire and Bradley have been absolutely brilliant! Claire did a great job of keeping me in the loop and answering all my questions in the lead up to my move.",
    name: 'Darnell Casimir',
    detail: 'Tenant',
  },
  {
    text: "Amazing service and advice. After months of looking for a flat in London with no success, I managed to find exactly what I needed. The agency ensures you are fully supported.",
    name: 'Uliana Kiseleva',
    detail: 'Tenant',
  },
  {
    text: "Claire has been very responsive and helpful throughout. She promptly assisted in getting the issues in my apartment resolved and communicated clearly at every step.",
    name: 'Harshit Jain',
    detail: 'Tenant',
  },
  {
    text: "Thank you, Claire and Bradley for your professionalism and dedication. You have gone above and beyond to help and support our transition. We highly recommend you.",
    name: 'Kim Benjamin',
    detail: 'Tenant',
  },
  {
    text: "Claire and Bradley have been managing my flat for some time and are doing a great job. Always responsive with my tenants and address issues timely. Friendly and professional.",
    name: 'Laura Bussa',
    detail: 'Landlord',
  },
]
...
function HeroCardStack({ properties, loading }: { properties: PropertyWithListing[]; loading: boolean }) {
      ...
      <div className="relative" style={{ height: '420px' }}>
        {[0, 1, 2].map((i) => (
          <div
            ...
            style={{ top: `${i * 30}px`, height: '200px', borderRadius: '4px', transform: `rotate(${HERO_ROTATIONS[i]}deg)` }}
          />
        ))}
      </div>
    )
  ...
  if (cards.length === 0) {
    return (
      ...
      >
        <p style={{ fontFamily: 'var(--font-syne)', fontWeight: 800, fontSize: '13px', letterSpacing: '0.12em', textTransform: 'uppercase', color: 'rgba(245,242,238,0.3)', marginBottom: '16px' }}>
          New properties coming soon
        </p>
        <p style={{ fontFamily: 'var(--font-dm-sans)', fontSize: '15px', color: 'rgba(245,242,238,0.5)', lineHeight: 1.7, marginBottom: '28px', maxWidth: '28ch', margin: '0 auto 28px' }}>
          We match tenants to properties before they hit the market. Register your search and we&apos;ll reach out the moment something fits.
        </p>
        <Link
          href="/tenants/find"
          style={{
...
function HeroSection({ properties, loading }: { properties: PropertyWithListing[]; loading: boolean }) {
    ...
    >
      ...
      >
        ...
        <div className="hidden md:block">
          <HeroCardStack properties={properties} loading={loading} />
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[45fr_55fr] gap-16 items-start">
          ...
          <RevealSection>
            ...
            <p style={{ fontFamily: 'var(--font-dm-sans)', fontSize: '16px', color: '#555', lineHeight: 1.75, maxWidth: '38ch' }}>
              We live in the areas we work in. That means local knowledge isn&apos;t a sales pitch — it&apos;s just how we operate. Our portfolio spans East London and beyond, so wherever the right property is, we&apos;ll find it.
            </p>
            <Link
              href="/properties"
...
function TestimonialsSection() {
  ...
  return <TestimonialCarousel testimonials={TESTIMONIALS} background="#f5f2ee" />
}
...
export default function HomePage() {
  ...
  return (
    <>
      <HeroSection properties={properties} loading={loading} />
