        ...
        <div className="max-w-[1200px] mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_380px] gap-16 items-start">
            ...
            <div>
              ...
              <h2 style={{ fontFamily: 'var(--font-syne)', fontWeight: 800, fontSize: 'clamp(1.75rem, 3vw, 2.5rem)', color: '#1a1a1a', letterSpacing: '-0.02em', lineHeight: 1.1, marginBottom: '28px' }}>
                Small agency. Big difference.
              </h2>
              <div style={{ fontFamily: 'var(--font-dm-sans)', fontSize: '15px', color: 'rgba(26,26,26,0.65)', lineHeight: 1.85 }} className="space-y-5">
                <p>
                  We don&apos;t run from a high street office. We live in the communities we manage — which means response times are fast, local knowledge is real, and there&apos;s no one passing messages between you and the person who actually makes decisions.
                </p>
                <p>
                  The portfolio is deliberately small. We take on properties we can manage properly, not ones we&apos;ll hand off to a junior or log in a system and forget about. Every landlord has our direct numbers. Every tenant does too.
                </p>
                <p>
                  We&apos;re rooted in East London — but our portfolio stretches across the city. If a property is a good fit, the postcode isn&apos;t a dealbreaker.
                </p>
              </div>
            </div>
            ...
            <div style={{ paddingTop: '4px' }}>
              <p style={{ fontFamily: 'var(--font-syne)', fontWeight: 600, fontSize: '11px', letterSpacing: '0.15em', textTransform: 'uppercase', color: 'rgba(26,26,26,0.35)', marginBottom: '24px' }}>
                How we work
              </p>
              <ul className="space-y-0" style={{ borderTop: '1px solid rgba(26,26,26,0.08)' }}>
                {[
                  'We answer our phones.',
                  'We know every landlord by name.',
                  'No hidden fees — ever.',
                  'Rooted in East London, working across the city.',
                  'We handle maintenance ourselves — no outsourced queues.',
                  'Deposits registered within 30 days. Always.',
                ].map((point) => (
                  <li
                    key={point}
                    style={{
