...
const LANDLORD_REVIEWS = [
  {
    text: "Claire and Bradley have been managing my flat for some time and are doing a great job. They are always responsive with my tenants and address issues timely. Friendly and professional — I highly recommend CGE.",
    name: 'Laura Bussa',
    detail: 'Landlord',
  },
  {
    text: "As a landlord, Central Gate Estates have provided an excellent and efficient management service ensuring that both myself and my tenants are fully supported. Their communication is excellent throughout.",
    name: 'Sharon Savory',
    detail: 'Landlord',
  },
  {
    text: "Highly responsive, friendly, professional and pro-active. Claire and Bradley have provided great service to us as landlords. We highly recommend them.",
    name: 'N.',
    detail: 'Landlord',
  },
  {
    text: "It has been a pleasure to work with Central Gate Estates over the past year. Claire and Bradley are professional, approachable and knowledgeable — would 100% recommend.",
    name: 'Checkwells Workspace',
    detail: 'Client',
  },
  {
    text: "Always very prompt to respond to my messages. They deal with any issues super quick and provide the best pricing. I would highly recommend them.",
    name: 'Philip Orme',
    detail: 'Landlord',
  },
  {
    text: "Claire and Bradley provide a good service and great value.",
    name: 'D F',
    detail: 'Landlord',
  },
]
...
export default function LandlordsPage() {
  return (
    <div className="min-h-screen" style={{ background: '#F0EBE0' }}>
      ...
      <TestimonialCarousel testimonials={LANDLORD_REVIEWS} background="#fff" />

      {/* Valuation CTA */}
      <section style={{ background: '#1e2420', padding: '100px 0' }}>
        <div className="max-w-[1200px] mx-auto px-6 text-center">
          <p style={{ fontFamily: 'var(--font-syne)', fontWeight: 600, fontSize: '11px', letterSpacing: '0.18em', textTransform: 'uppercase', color: '#5db07a', marginBottom: '20px' }}>
            Free Rental Valuation
          </p>
          <h2 style={{ fontFamily: 'var(--font-syne)', fontWeight: 800, fontSize: 'clamp(2rem, 5vw, 3.5rem)', color: '#f5f2ee', letterSpacing: '-0.03em', lineHeight: 1, marginBottom: '20px' }}>
            Find out what your property is worth.
          </h2>
          <p style={{ fontFamily: 'var(--font-dm-sans)', fontSize: '16px', color: 'rgba(245,242,238,0.5)', lineHeight: 1.75, maxWidth: '44ch', margin: '0 auto 40px' }}>
            Takes two minutes. Tell us about your property and we&apos;ll come back with a rental estimate, a service recommendation, and straight answers on fees.
          </p>
          <div className="flex flex-wrap items-center justify-center gap-4">
            <a href="/landlords/valuation" className="btn-primary" style={{ fontSize: '15px', padding: '14px 32px' }}>
            ...
            <a
              ...
              style={{ fontFamily: 'var(--font-dm-sans)', fontSize: '14px', fontWeight: 500, color: 'rgba(245,242,238,0.55)', textDecoration: 'none', borderBottom: '1px solid rgba(245,242,238,0.2)', paddingBottom: '1px' }}
            >
          ...
          <div className="flex items-center justify-center gap-8 mt-12">
            {['No obligation', 'Response within 24 hours', 'No hard sell'].map((item) => (
              <div key={item} className="flex items-center gap-2">
                <CheckCircle size={13} style={{ color: '#5db07a', flexShrink: 0 }} />
                <span style={{ fontFamily: 'var(--font-dm-sans)', fontSize: '13px', color: 'rgba(245,242,238,0.4)' }}>{item}</span>
              </div>
            ))}
          </div>
        </div>
