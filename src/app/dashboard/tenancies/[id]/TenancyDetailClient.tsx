...
export default function TenancyDetailClient({ tenancy }: { tenancy: TenancyFull }) {
  ...
  const [form, setForm] = useState<EditState>({
    ...
    rentReviewDate: tenancy.rentReviewDate ? toISODate(tenancy.rentReviewDate) : '',
  ...
  async function saveDetails() {
    ...
    try {
      ...
      if (form.rentReviewDate) body.rentReviewDate = form.rentReviewDate
      else body.rentReviewDate = null
        ...
        <div className="space-y-4">
          ...
          <div className="bg-white rounded-xl border border-gray-200 divide-y divide-gray-50">
            ...
            {[
              ...
              { label: 'Rent Review', key: 'rentReviewDate' as const, type: 'date' },
                ...
                {editing ? (
                  ...
                  <span className="text-sm text-[#1a1a1a] font-medium">
                    {key === 'rentAmount' ? `£${form.rentAmount} pcm` :
                     ...
                     key === 'startDate' || key === 'endDate' || key === 'breakClauseDate' || key === 'rentReviewDate'
