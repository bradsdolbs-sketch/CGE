    ...
    <div className="max-w-2xl space-y-6">
      ...
      <form onSubmit={handleSubmit} className="bg-white rounded-xl border border-gray-200 p-6 space-y-6">
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div>
            <label className={labelClass}>Rent Review Date</label>
            <input type="date" className={inputClass} value={form.rentReviewDate} onChange={(e) => set('rentReviewDate', e.target.value)} />
          </div>
        </div>
        <div>
