  ...
  try {
    ...
    const property = await prisma.property.update({
      ...
      data: {
        ...
        // tenure is a nullable enum — empty string must become null
        ...(tenure !== undefined && { tenure: tenure || null }),
        ...
        ...(epcRating !== undefined && { epcRating: epcRating || null }),
        ...(councilTaxBand !== undefined && { councilTaxBand: councilTaxBand || null }),
